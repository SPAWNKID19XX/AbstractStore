...
## 📁 Project Structure — Django REST Framework Apps
| App | Назначение                                                  | Status |
|-----|-------------------------------------------------------------|--------|
| **users** | Управление пользователями, аутентификация, профили          | OK     |
| **products** | Каталог товаров, категории, атрибуты, изображения           | OK      |
| **inventory** | Учёт запасов и складских остатков                           |
| **cart** | Корзина пользователя и промо-коды                           |
| **orders** | Управление заказами и статусами, Процесс оформления заказа  |
| **payments** | Интеграция с платёжными системами                           |
| **shipping** | Настройка доставки и трекинг                                |
| **promotions** | Купоны, акции, скидочные правила                            |
| **reviews** | Отзывы, рейтинги, модерация контента                        |
| **notifications** | E-mail/SMS/push уведомления                                 |
| **content** | CMS-страницы, баннеры, информационные блоки                 |
| **search** | Поиск и фильтрация по каталогу                              |
| **analytics** | Сбор и анализ статистики                                    |
| **wishlists** | Списки желаемого, “избранное”, публичные токены для шаринга |
