...
class TestProduct:
    ...
    def test_patch_product(self,auth_client_superuser ,product_data):
        client, user = auth_client_superuser
    ...
    def test_put_product(self,auth_client_superuser ,product_data):
        client, user = auth_client_superuser
        new_product = client.post(
            "/products/api/v1/",
            data=product_data,
    ...
    def test_distroy_product(self,auth_client_superuser ,product_data):
        client, user = auth_client_superuser
        new_product = client.post(
            "/products/api/v1/",
            data=product_data,
